  ...
  function(e, t, n) {
    ...
    t.a = o.a
      ...
      .constant("$authconf", {
        ...
        port: 6800,
        encrypt: !1,
        auth: {token:'zkinMD4wJuDFjldb6uRHrR6V4'},
        directURL: ""
      })
      .constant("$enable", {
        torrent: !0,
            ...
            (e.getProgressClass = function(e) {
              switch (e.status) {
                ...
                case "verifing":
                  return "progress-bar-warning";
                case "complete":
                  if(e.incompleteflag){let myNotification = new Notification('Atom Bomb', {body: '下载已完成。'});e.incompleteflag = false;}
      ...
      .controller("ModalCtrl", [
        ...
        function(e, t, n, a, o, r, s) {
          (t.getUris = {
            ...
            e.each(["about", "server_info","help"], function(e) {
              t[e] = {
                open: function() {
                  var a = this;
